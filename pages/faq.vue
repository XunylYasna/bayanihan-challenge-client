      ...
      <div class="py-20 bg-gray-50 radius-for-skewed">
        <div class="border-b">
          <div class="mb-16 max-w-xl mx-auto px-4 text-center">
            <span class="text-blue-700 font-bold" data-config-id="caption"
              >Dolor sit amet consectutar</span
            >
            <h2
              class="text-4xl text-gray-800 lg:text-5xl font-bold font-heading"
            ...
            <ul>
              <li class="py-12 pr-4 border-b">
                <button
                  ...
                  "
                >
                  <span class="text-xl text-gray-800" data-config-id="q1"
                ...
                <p
                  class="mt-4 pr-4 text-gray-400 font-normal leading-loose"
                  data-config-id="a1"
                >
              ...
              <li class="py-6 lg:py-12 pr-4 border-b">
                <button
                  ...
                  "
                >
                  <span class="text-xl text-gray-800" data-config-id="q2"
                    >Nunc maximus odio sit amet eros faucibus?</span
                  >
                  <svg
                    class="w-8 h-8 text-blue-700"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li class="py-6 lg:py-12 pr-4 border-b">
                <button
                  ...
                  "
                >
                  <span class="text-xl text-gray-800" data-config-id="q3"
                    >Nunc maximus odio sit amet eros faucibus?</span
                  >
                  <svg
                    class="w-8 h-8 text-blue-700"
              ...
              <li class="py-6 lg:py-12 pr-4 border-b">
                <button
                  ...
                  "
                >
                  <span class="text-xl text-gray-800" data-config-id="q4"
                    >Nunc maximus odio sit amet eros faucibus?</span
                  >
                  <svg
                    class="w-8 h-8 text-blue-700"
              ...
              <li class="py-6 lg:py-12 pr-4 border-b">
                <button
                  ...
                  "
                >
                  <span class="text-xl text-gray-800" data-config-id="q5"
                    >Nunc maximus odio sit amet eros faucibus?</span
                  >
                  <svg
                    class="w-8 h-8 text-blue-700"
              ...
              <li class="py-6 lg:py-12 pr-4 border-b">
                <button
                  ...
                  "
                >
                  <span class="text-xl text-gray-800" data-config-id="q6"
                    >Nunc maximus odio sit amet eros faucibus?</span
                  >
                  <svg
                    class="w-8 h-8 text-blue-700"
