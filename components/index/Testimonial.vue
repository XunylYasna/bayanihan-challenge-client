  ...
  <section>
    <div class="py-20 bg-white radius-for-skewed">
      <div class="container mx-auto px-4">
        <div class="mx-auto py-10 bg-gray-50 shadow rounded">
          <div class="max-w-5xl p-4 flex flex-wrap justify-center items-center">
            <div class="mb-6 w-full lg:w-1/3 text-center">
              <img
                ...
                alt=""
              />
              <h4 class="text-xl text-gray-800">Coach Jose</h4>
              <p class="text-blue-700">Atleta Ako</p>
            </div>
            <div class="w-full lg:w-2/3">
              <svg
                class="mb-4 text-blue-700 h-10"
                viewbox="0 0 32 28"
                fill="none"
              ...
              <div>
                ...
                <button class="mr-1 bg-gray-200 rounded-full p-1"></button>
                <button class="mr-1 bg-blue-700 rounded-full p-1"></button>
