<template>
  <section>
    ...
    <div class="py-20 bg-gray-50 radius-for-skewed bg-yellow-400">
      <div class="container mx-auto px-4">
        <div class="mb-20 max-w-lg text-center mx-auto">
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="mb-16 lg:mb-0 relative w-full md:w-1/2 lg:w-1/3 px-4">
            <svg
              class="absolute top-0 left-0 -mt-10 ml-4 text-blue-700"
              width="36"
              height="101"
              viewbox="0 0 36 101"
              fill="none"
            ...
            <h3 class="text-2xl font-bold" data-config-id="header1">
          ...
          <div class="mb-16 lg:mb-0 relative w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            <h3 class="text-2xl font-bold" data-config-id="header2">
              Log your activity
            </h3>
          ...
          <div class="relative w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            <h3 class="text-2xl font-bold" data-config-id="header3">
